    ...
    origins:
      ...
      suboptions:
        ...
        s3_origin_access_control_id:
          description:
            - Specify origin access control ID for to be used to sign requests to origins (for auth in IAM policies). Replaces old origin access identity.
            - See also U(https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/private-content-restricting-access-to-s3.html#create-oac-overview-s3).
          type: str          
        s3_origin_config:
  ...
  contains:
    items:
      ...
      contains:
        ...
        s3_origin_access_control_id:
          description:
            - Origin access control ID for to be used to sign requests to origins. Replaces old origin access identity.
          type: str            
        s3_origin_config:
